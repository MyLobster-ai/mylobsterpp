...
// v2026.5.2 parity: extensions/anthropic/stream-wrappers.test.ts
//
...
TEST_CASE("v5.2 anthropic stream-wrappers: strips context-1m for OAuth/legacy token",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: keeps context-1m for API key auth",
          "[v5_2][providers][anthropic][stream_wrapper][behavior]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: skips service_tier for OAuth in composed chain",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: composes provider stream from extra params",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: removes trailing assistant prefill when thinking enabled",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][thinking]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: keeps assistant prefill when thinking disabled",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][thinking]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: keeps trailing assistant tool_use turns",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][thinking]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: fast-mode skips service_tier for OAuth",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][fast_mode]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: fast-mode injects service_tier=auto for API key",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][fast_mode]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: fast-mode disabled injects service_tier=standard_only",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][fast_mode]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: fast-mode skips service_tier for non-anthropic provider",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][fast_mode]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: service_tier wrapper skips OAuth",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][service_tier]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: service_tier wrapper injects auto for API key",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][service_tier]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: service_tier wrapper injects standard_only for API key",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][service_tier]") {
...
TEST_CASE("v5.2 anthropic stream-wrappers: service_tier wrapper skips non-anthropic provider",
          "[v5_2][parity_gap][providers][anthropic][stream_wrapper][service_tier]") {
