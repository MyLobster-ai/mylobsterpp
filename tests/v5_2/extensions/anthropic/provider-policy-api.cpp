...
// v2026.5.2 parity: extensions/anthropic/provider-policy-api.test.ts
//
...
TEST_CASE("v5.2 anthropic provider-policy-api: normalizeConfig (anthropic)",
          "[v5_2][parity_gap][providers][anthropic][policy_api]") {
...
TEST_CASE("v5.2 anthropic provider-policy-api: normalizeConfig (claude-cli)",
          "[v5_2][parity_gap][providers][anthropic][policy_api]") {
...
TEST_CASE("v5.2 anthropic provider-policy-api: normalizeConfig leaves non-Anthropic untouched",
          "[v5_2][parity_gap][providers][anthropic][policy_api]") {
...
TEST_CASE("v5.2 anthropic provider-policy-api: applyConfigDefaults sets cache-ttl pruning",
          "[v5_2][parity_gap][providers][anthropic][policy_api]") {
