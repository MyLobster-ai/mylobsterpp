...
// v2026.5.2 parity: extensions/anthropic/index.test.ts (anthropic plugin entry)
//
...
TEST_CASE("v5.2 anthropic plugin: registers the claude-cli backend",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: owns native reasoning output mode",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: owns replay policy for Claude transports",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: normalizeConfig defaults provider api",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: normalizeConfig defaults claude-cli provider api",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: normalizeConfig leaves non-Anthropic provider untouched",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: applyConfigDefaults sets pruning + heartbeat",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: backfills Claude CLI allowlist defaults",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: resolveDynamicModel for claude-opus-4-7 from 4.6 family",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: 1M context eligibility for claude-opus-4.7 variants",
          "[v5_2][providers][anthropic][behavior]") {
...
TEST_CASE("v5.2 anthropic plugin: resolveThinkingProfile for 4.6 vs 4.7",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: normalizeResolvedModel forces 1M for 4.7",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: resolveSyntheticAuth for claude-cli oauth",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: resolveSyntheticAuth for claude-cli token",
          "[v5_2][parity_gap][providers][anthropic]") {
...
TEST_CASE("v5.2 anthropic plugin: stores claude-cli auth profile via cli auth.run",
          "[v5_2][parity_gap][providers][anthropic]") {
