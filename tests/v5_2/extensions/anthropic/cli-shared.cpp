...
// v2026.5.2 parity: extensions/anthropic/cli-shared.test.ts
//
...
TEST_CASE("v5.2 anthropic cli-shared: normalizeClaudePermissionArgs",
          "[v5_2][parity_gap][providers][anthropic][cli]") {
...
TEST_CASE("v5.2 anthropic cli-shared: normalizeClaudeSettingSourcesArgs",
          "[v5_2][parity_gap][providers][anthropic][cli]") {
...
TEST_CASE("v5.2 anthropic cli-shared: normalizeClaudeBackendConfig",
          "[v5_2][parity_gap][providers][anthropic][cli]") {
...
TEST_CASE("v5.2 anthropic cli-shared: resolveClaudePermissionMode",
          "[v5_2][parity_gap][providers][anthropic][cli]") {
...
TEST_CASE("v5.2 anthropic cli-shared: CLAUDE_CLI_CLEAR_ENV constant",
          "[v5_2][parity_gap][providers][anthropic][cli]") {
    PARITY_GAP("extensions/anthropic/cli-shared.test.ts",
               "CLAUDE_CLI_CLEAR_ENV",
...
TEST_CASE("v5.2 anthropic cli-shared: buildAnthropicCliBackend",
          "[v5_2][parity_gap][providers][anthropic][cli]") {
