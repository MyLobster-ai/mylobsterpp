...
// v2026.5.2 parity: extensions/anthropic/cli-migration.test.ts
//
...
TEST_CASE("v5.2 anthropic cli-migration: hasClaudeCliAuth detects existing profile",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
               "hasClaudeCliAuth",
               "No auth profile registry to inspect.");
}

TEST_CASE("v5.2 anthropic cli-migration: buildAnthropicCliMigrationResult shapes profile",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
...
TEST_CASE("v5.2 anthropic cli-migration: cli auth.run interactive path",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
...
TEST_CASE("v5.2 anthropic cli-migration: cli auth.run non-interactive path",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
...
TEST_CASE("v5.2 anthropic cli-migration: surfaces wizard errors when CLI absent",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
...
TEST_CASE("v5.2 anthropic cli-migration: skips migration when profile already exists",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
               "skip-on-existing",
...
TEST_CASE("v5.2 anthropic cli-migration: does not migrate without claude-cli credentials",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
...
TEST_CASE("v5.2 anthropic cli-migration: handles oauth credential type",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
               "oauth credential",
...
TEST_CASE("v5.2 anthropic cli-migration: handles token credential type",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
               "token credential",
...
TEST_CASE("v5.2 anthropic cli-migration: returns empty profiles when read returns null",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
...
TEST_CASE("v5.2 anthropic cli-migration: respects allowSecretRefPrompt",
          "[v5_2][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
