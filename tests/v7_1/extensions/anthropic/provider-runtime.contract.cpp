...
// v2026.7.1 parity: extensions/anthropic/provider-runtime.contract.test.ts
//
...
TEST_CASE("v7.1 anthropic runtime-contract: resolveDynamicModel 4.6 forward-compat",
          "[v7_1][parity_gap][providers][anthropic][contract]") {
...
TEST_CASE("v7.1 anthropic runtime-contract: resolveUsageAuth for OAuth",
          "[v7_1][parity_gap][providers][anthropic][contract]") {
...
TEST_CASE("v7.1 anthropic runtime-contract: buildAuthDoctorHint",
          "[v7_1][parity_gap][providers][anthropic][contract]") {
...
TEST_CASE("v7.1 anthropic runtime-contract: fetchUsageSnapshot via OAuth",
          "[v7_1][parity_gap][providers][anthropic][contract]") {
...
TEST_CASE("v7.1 anthropic runtime-contract: normalizeResolvedModel 1M context",
          "[v7_1][parity_gap][providers][anthropic][contract]") {
...
TEST_CASE("v7.1 anthropic runtime-contract: resolveSyntheticAuth contract",
          "[v7_1][parity_gap][providers][anthropic][contract]") {
    PARITY_GAP("src/plugin-sdk/test-helpers/provider-runtime-contract.ts",
...
TEST_CASE("v7.1 anthropic runtime-contract: per-channel runtime hooks",
          "[v7_1][parity_gap][providers][anthropic][contract]") {
    PARITY_GAP("src/plugin-sdk/test-helpers/provider-runtime-contract.ts",
...
TEST_CASE("v7.1 anthropic runtime-contract: refreshOpenAICodexToken cross-mock isolation",
          "[v7_1][parity_gap][providers][anthropic][contract]") {
