...
// v2026.7.1 parity: extensions/anthropic/cli-migration.test.ts
//
...
TEST_CASE("v7.1 anthropic cli-migration: hasClaudeCliAuth detects existing profile",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
               "hasClaudeCliAuth",
               "No auth profile registry to inspect.");
}

TEST_CASE("v7.1 anthropic cli-migration: buildAnthropicCliMigrationResult shapes profile",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
...
TEST_CASE("v7.1 anthropic cli-migration: cli auth.run interactive path",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
...
TEST_CASE("v7.1 anthropic cli-migration: cli auth.run non-interactive path",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
...
TEST_CASE("v7.1 anthropic cli-migration: surfaces wizard errors when CLI absent",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
...
TEST_CASE("v7.1 anthropic cli-migration: skips migration when profile already exists",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
               "skip-on-existing",
...
TEST_CASE("v7.1 anthropic cli-migration: does not migrate without claude-cli credentials",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
...
TEST_CASE("v7.1 anthropic cli-migration: handles oauth credential type",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
               "oauth credential",
...
TEST_CASE("v7.1 anthropic cli-migration: handles token credential type",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
               "token credential",
...
TEST_CASE("v7.1 anthropic cli-migration: returns empty profiles when read returns null",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
...
TEST_CASE("v7.1 anthropic cli-migration: respects allowSecretRefPrompt",
          "[v7_1][parity_gap][providers][anthropic][cli][migration]") {
    PARITY_GAP("extensions/anthropic/cli-migration.test.ts",
