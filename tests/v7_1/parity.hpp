...
// v2026.7.1 OpenClaw test parity helpers.
//
// Each upstream Vitest file (`extensions/<id>/<name>.test.ts`) is mirrored by a
// Catch2 file under `tests/v7_1/<path>/<name>.cpp`. Behavioral assertions that
...
// red bar is the v7.1 parity backlog.
//
...
#define PARITY_GAP(upstream_ref, missing, note)                                              \
    FAIL("v7.1 parity gap [" missing "] (" upstream_ref "): " note)

// Tag aliases used for consistency:
//   [v7_1]         — every ported test
