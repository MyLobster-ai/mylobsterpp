...
TEST_CASE("v4.29 anthropic plugin: registers the claude-cli backend",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: owns native reasoning output mode",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: owns replay policy for Claude transports",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: normalizeConfig defaults provider api",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: normalizeConfig defaults claude-cli provider api",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: normalizeConfig leaves non-Anthropic provider untouched",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: applyConfigDefaults sets pruning + heartbeat",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: backfills Claude CLI allowlist defaults",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: resolveDynamicModel for claude-opus-4-7 from 4.6 family",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: 1M context eligibility for claude-opus-4.7 variants",
          "[v4_29][providers][anthropic][behavior]") {
...
TEST_CASE("v4.29 anthropic plugin: resolveThinkingProfile for 4.6 vs 4.7",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: normalizeResolvedModel forces 1M for 4.7",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: resolveSyntheticAuth for claude-cli oauth",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: resolveSyntheticAuth for claude-cli token",
          "[v4_29][parity_gap][providers][anthropic]") {
...
TEST_CASE("v4.29 anthropic plugin: stores claude-cli auth profile via cli auth.run",
          "[v4_29][parity_gap][providers][anthropic]") {
