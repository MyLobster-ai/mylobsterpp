...
TEST_CASE("v4.29 anthropic runtime-contract: resolveDynamicModel 4.6 forward-compat",
          "[v4_29][parity_gap][providers][anthropic][contract]") {
...
TEST_CASE("v4.29 anthropic runtime-contract: resolveUsageAuth for OAuth",
          "[v4_29][parity_gap][providers][anthropic][contract]") {
...
TEST_CASE("v4.29 anthropic runtime-contract: buildAuthDoctorHint",
          "[v4_29][parity_gap][providers][anthropic][contract]") {
...
TEST_CASE("v4.29 anthropic runtime-contract: fetchUsageSnapshot via OAuth",
          "[v4_29][parity_gap][providers][anthropic][contract]") {
...
TEST_CASE("v4.29 anthropic runtime-contract: normalizeResolvedModel 1M context",
          "[v4_29][parity_gap][providers][anthropic][contract]") {
...
TEST_CASE("v4.29 anthropic runtime-contract: resolveSyntheticAuth contract",
          "[v4_29][parity_gap][providers][anthropic][contract]") {
    PARITY_GAP("src/plugin-sdk/test-helpers/provider-runtime-contract.ts",
...
TEST_CASE("v4.29 anthropic runtime-contract: per-channel runtime hooks",
          "[v4_29][parity_gap][providers][anthropic][contract]") {
    PARITY_GAP("src/plugin-sdk/test-helpers/provider-runtime-contract.ts",
...
TEST_CASE("v4.29 anthropic runtime-contract: refreshOpenAICodexToken cross-mock isolation",
          "[v4_29][parity_gap][providers][anthropic][contract]") {
